...
public class PessoaJuridica implements CalculoEmprestimo {
	...
	public void calcularEmprestimo(ClienteModel cliente, BigDecimal valorEmprestimo, Integer numeroParcela) {
		...
		BigDecimal juros = valorDaParcela.multiply(new BigDecimal(0.4)).multiply(new BigDecimal(1));
		
		EmprestimoModel emprestimo = EmprestimoBuilder.builder(TipoPessoaEnum.PESSOA_JURIDICA)
				.id()
