...
public class Aposentado implements CalculoEmprestimo {
	...
	public void calcularEmprestimo(ClienteModel cliente, BigDecimal valorEmprestimo, Integer numeroParcela) {
		...
		BigDecimal juros = valorDaParcela.multiply(new BigDecimal(1.0)).multiply(new BigDecimal(1));
		
		EmprestimoModel emprestimo = EmprestimoBuilder.builder(TipoPessoaEnum.APOSENTADO)
				.id()
